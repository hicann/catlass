...
#ifndef ACT_EPILOGUE_BLOCK_EPILOGUE_GEMM_DEQUANT_HPP
#define ACT_EPILOGUE_BLOCK_EPILOGUE_GEMM_DEQUANT_HPP
...
public:
    ...
    static constexpr bool RowOrColumn = std::is_same<LayoutC, Act::layout::RowMajor>::value && std::is_same<LayoutX, Act::layout::RowMajor>::value;
    ...
    void operator()(
        ...
        AscendC::GlobalTensor<ElementX> gmBlockX, LayoutX layoutX, GemmCoord actualShape
    ){
...
#endif // ACT_EPILOGUE_BLOCK_EPILOGUE_GEMM_DEQUANT_HPP