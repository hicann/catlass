 ...
 */
 ...
 #ifndef ASCENDCT_GEMV_KERNLE_GEMV_AIV_HPP
 #define ASCENDCT_GEMV_KERNLE_GEMV_AIV_HPP
 ...
 public:
     ...
     void operator()<AscendC::AIV>(Params const &params) {
        ...
        float Realbeta= params.beta;
         if constexpr (std::is_same_v<LayoutA, AscendCT::layout::ColumnMajor>){
 ...
 #endif // ASCENDCT_GEMV_KERNLE_GEMV_AIV_HPP