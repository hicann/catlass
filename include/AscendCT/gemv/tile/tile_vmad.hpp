...
#ifndef ASCENDCT_GEMV_TILE_TILE_VMAD_HPP
#define ASCENDCT_GEMV_TILE_TILE_VMAD_HPP
...
namespace AscendCT::gemv::tile
{
    ...
    struct TileVmad<arch::AtlasA2,
                    gemm::MatmulType<half, layout::RowMajor>,
                    gemm::MatmulType<half, layout::VectorLayout>,
                    gemm::MatmulType<half, layout::VectorLayout>,
                    void>
    {
        using ElementA = half;
    ...
    struct TileVmad<arch::AtlasA2,
                    gemm::MatmulType<ElementA, layout::RowMajor>,
                    gemm::MatmulType<ElementX, layout::VectorLayout>,
                    gemm::MatmulType<ElementY, layout::VectorLayout>,
                    void>
    {
        using ElementAccumulator =
    ...
    template <>
    struct TileVmad<arch::AtlasA2,
                    gemm::MatmulType<half, layout::ColumnMajor>,
                    gemm::MatmulType<half, layout::VectorLayout>,
                    gemm::MatmulType<half, layout::VectorLayout>,
                    void>
    {
    ...
    template <
        ...
        class ElementY>
    struct TileVmad<arch::AtlasA2,
                    gemm::MatmulType<ElementA, layout::ColumnMajor>,
                    gemm::MatmulType<ElementX, layout::VectorLayout>,
                    gemm::MatmulType<ElementY, layout::VectorLayout>,
                    void>
    {
