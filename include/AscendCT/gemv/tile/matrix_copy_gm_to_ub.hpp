 ...
 */
 ...
 namespace acot::gemv::tile
 {
     ...
     struct MatrixCopyGmToUB<arch::AtlasA2, gemm::MatmulType<Element, layout::RowMajor>>
     {
     ...
     template <class Element>
     struct MatrixCopyGmToUB<arch::AtlasA2, gemm::MatmulType<Element, layout::ColumnMajor>>
     {
 ...
 #endif // ASCENDCT_GEMV_TILE_MATRIX_COPY_GM_TO_UB_HPP
