 ...
 */
 ...
 #ifndef ASCENDCT_GEMV_TILE_VEC_COPY_UB_TO_GM_HPP
 #define ASCENDCT_GEMV_TILE_VEC_COPY_UB_TO_GM_HPP
 ...
 namespace AscendCT::gemv::tile
 {
     ...
     struct VecCopyUBToGm<arch::AtlasA2, gemm::MatmulType<Element, layout::VectorLayout>>
     {
     ...
     template <class Element>
     struct VecCopyUBToGm<arch::AtlasA2, gemm::MatmulType<Element, layout::VectorLayout>,true>
     {
         using LayoutSrc = layout::VectorLayout;
         using LayoutDst = layout::VectorLayout;
         static constexpr uint32_t ELE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element); 
 ...
 #endif // ASCENDCT_GEMV_TILE_VEC_COPY_UB_TO_GM_HPP
