 ...
 */
 ...
 #ifndef ASCENDCT_GEMV_HELPER_HPP
 #define ASCENDCT_GEMV_HELPER_HPP
 
 #include "AscendCT/AscendCT.hpp"
 #include "AscendCT/layout/layout.hpp"
 #include "AscendCT/gemm/matmul_type.hpp"
 namespace AscendCT::gemv::helper {
 ...
 template<class Element>
 struct IsAtoaddSelector<gemm::MatmulType<Element, layout::RowMajor>> {
    static constexpr bool value = false;
 };

 template<class Element>
 struct IsAtoaddSelector<gemm::MatmulType<Element, layout::ColumnMajor>> {
 ...
 #endif // ASCENDCT_GEMV_HELPER_HPP
