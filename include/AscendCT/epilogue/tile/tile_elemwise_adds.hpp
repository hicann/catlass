 ...
 */
 ...
 #ifndef ASCENDCT_EPILOGUE_TILE_TILE_ELEMWISE_ADDS_HPP
 #define ASCENDCT_EPILOGUE_TILE_TILE_ELEMWISE_ADDS_HPP
 ...
 struct TileElemWiseAdds{
     ...
     void operator()(
         ...
         AscendC::Adds(dstLocal, srcTensor, scalar, COMPUTE_LENGTH);
     }
 };
 }
