...
#ifndef ASCENDCT_EPILOGUE_TILE_TILE_COPY_UB_TO_GM_HPP
#define ASCENDCT_EPILOGUE_TILE_TILE_COPY_UB_TO_GM_HPP
...
struct CopyUb2Gm<arch::AtlasA2, gemm::MatmulType<Element, layout::RowMajor>> {
...
template <typename Element>
struct CopyUb2Gm<arch::AtlasA2, gemm::MatmulType<Element, layout::ColumnMajor>> {
...
template <typename Element>
struct CopyUb2GmAligned<arch::AtlasA2, gemm::MatmulType<Element, layout::RowMajor>> {
    using LayoutSrc = layout::RowMajor;
    using LayoutDst = layout::RowMajor;
