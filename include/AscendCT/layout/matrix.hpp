...
#ifndef ASCENDCT_LAYOUT_MATRIX_HPP
#define ASCENDCT_LAYOUT_MATRIX_HPP
...
struct nN {
    ...
    public:
     ...
     /// Make the layout of a coordinate (row, column)
     template <class Element>
     ASCENDCT_HOST_DEVICE static nN MakeLayout(Index orgRows, Index orgCols) {
...
#endif  // ASCENDCT_LAYOUT_MATRIX_HPP