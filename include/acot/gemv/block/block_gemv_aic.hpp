...
#ifndef ACOT_GEMV_BLOCK_BLOCK_AIC_HPP
#define ACOT_GEMV_BLOCK_BLOCK_AIC_HPP
...
namespace acot::gemv::block
{
    ...
    template <
        ...
        class TileMmad_>
    struct BlockGemv<
        matmul::MmadAtlasA2Preload<ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_>,
        L1TileShape_,
        L0TileShape_,
        AType_,
        XType_,
    ...
    public:
        // Type Aliases
        using DispatchPolicy = matmul::MmadAtlasA2Preload<ENABLE_UNIT_FLAG_, ENABLE_SHUFFLE_K_>;
...
#endif // ACOT_GEMV_BLOCK_BLOCK_AIC_HPP