...
#ifndef ACOT_MATMUL_KERNEL_OPTIMIZED_MATMUL_V2_HPP
#define ACOT_MATMUL_KERNEL_OPTIMIZED_MATMUL_V2_HPP
...
public:
    ...
    using CopyGm2Ub = acot::matmul::tile::TileCopyV2<ArchTag, TensorInnerSrcGm, TensorInnerUb>;
    using CopyUb2Gm = acot::matmul::tile::TileCopyExt<ArchTag, TensorInnerUb,
...
public:
    ...
    void operator()<AscendC::AIC>(Params const &params)
    {
        ...
        TileScheduler matmulTileScheduler(params.problemShape, MakeCoord(L1_TILE_M, L1_TILE_N));
        ...
        for (uint32_t loopIdx = AscendC::GetBlockIdx(); loopIdx < coreLoops; loopIdx += AscendC::GetBlockNum()) {
            ...
            if (loopIdx + AscendC::GetBlockNum() < coreLoops) {
                hasNextBlock = true;
                nextBlockCoord = matmulTileScheduler.GetBlockCoord(loopIdx + AscendC::GetBlockNum());
                nextActualBlockShape = matmulTileScheduler.GetActualBlockShape(nextBlockCoord);
            }
...
#endif // ACOT_MATMUL_KERNEL_OPTIMIZED_MATMUL_V2_HPP
