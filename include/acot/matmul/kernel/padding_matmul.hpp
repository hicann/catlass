...
public:
    ...
    using ComputeLayoutDst = acot::layout::PaddingRowMajor;
    using CopyGm2Ub = acot::epilogue::tile::CopyGm2Ub<
        ArchTag, matmul::MatmulType<Element, ComputeLayout>>;
...
public:
    ...
    void operator()<AscendC::AIC>(Params const &params)
    {
        ...
        for (uint32_t loopIdx = AscendC::GetBlockIdx(); loopIdx < coreLoops; loopIdx += AscendC::GetBlockNum()) {
            ...
            MatmulCoord blockIdxCoord = matmulTileScheduler.GetBlockCoord(loopIdx);
            MatmulCoord actualBlockShape = matmulTileScheduler.GetActualBlockShape(blockIdxCoord);
