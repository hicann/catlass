...
#ifndef ACOT_MATMUL_TILE_COPY_UB_TO_GM_HPP
#define ACOT_MATMUL_TILE_COPY_UB_TO_GM_HPP
...
struct TileCopyV2<arch::AtlasA2, Tensor<AscendC::LocalTensor<ElementSrc>, LayoutSrc_, AscendC::TPosition::VECCALC>,
...
template <class ElementSrc, class ElementDst, class LayoutSrc_, class LayoutDst_>
struct TileCopyExt<arch::AtlasA2, Tensor<AscendC::LocalTensor<ElementSrc>, LayoutSrc_, AscendC::TPosition::VECCALC>,
    Tensor<AscendC::GlobalTensor<ElementDst>, LayoutDst_, AscendC::TPosition::GM>,
...
#endif // ACOT_MATMUL_TILE_COPY_UB_TO_GM_HPP