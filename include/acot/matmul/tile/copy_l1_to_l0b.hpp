...
#ifndef ACOT_MATMUL_TILE_COPY_L1_TO_L0B_HPP
#define ACOT_MATMUL_TILE_COPY_L1_TO_L0B_HPP
...
struct CopyL1ToL0B<ArchTag, matmul::MatmulType<int8_t, layout::zN>> {
...
struct CopyL1ToL0B<ArchTag, matmul::MatmulType<Element, layout::zN>> {
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zN;
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, matmul::MatmulType<Element, layout::nZ>> {
    using LayoutDst = layout::nZ;
...
#endif // ACOT_MATMUL_TILE_COPY_L1_TO_L0B_HPP