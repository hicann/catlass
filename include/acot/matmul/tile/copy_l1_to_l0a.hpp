...
#ifndef ACOT_MATMUL_TILE_COPY_L1_TO_L0A_HPP
#define ACOT_MATMUL_TILE_COPY_L1_TO_L0A_HPP
...
struct CopyL1ToL0A<ArchTag, matmul::MatmulType<Element, layout::zN>> {
...
template <class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, matmul::MatmulType<Element, layout::nZ>> {
    using LayoutDst = layout::zZ;
...
struct CopyL1ToL0A<ArchTag, matmul::MatmulType<int8_t, layout::nZ>> {
...
struct TileCopyV2<arch::AtlasA2, Tensor<AscendC::LocalTensor<ElementSrc>, LayoutSrc_, AscendC::TPosition::A1>,
...
struct TileCopyV2<arch::AtlasA2, Tensor<AscendC::LocalTensor<int8_t>, LayoutSrc_, AscendC::TPosition::A1>,
...
#endif // ACOT_MATMUL_TILE_COPY_L1_TO_L0A_HPP