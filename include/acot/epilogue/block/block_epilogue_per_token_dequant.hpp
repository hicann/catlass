...
#ifndef ACOT_EPILOGUE_BLOCK_EPILOGUE_PER_TOKEN_DEQUANT_HPP
#define ACOT_EPILOGUE_BLOCK_EPILOGUE_PER_TOKEN_DEQUANT_HPP
...
class BlockEpilogue <
    EpilogueAtlasA2PerTokenDequant<UB_STAGES_>,
    CType_,
    matmul::MatmulType<float, LayoutScale_>,
    matmul::MatmulType<float, LayoutPerTokenScale_>,
    DType_,
    TileRowBroadcastMul_,
    TileBroadcastOneBlk_,
    TileOneBlkColumnBroadcastMul_,
...
#endif  // ACOT_EPILOGUE_BLOCK_EPILOGUE_PER_TOKEN_DEQUANT_HPP
