...
#ifndef CATLASS_GEMM_KERNEL_QUANT_MATMUL_FP_HPP
#define CATLASS_GEMM_KERNEL_QUANT_MATMUL_FP_HPP
...
// Template for matmul perchn dequant kernel. Compute D = (A * B + X) * Scale
    template <
            class BlockMmad_,
    ...
    public:
        ...
        struct Params {
            ...
            Params(
                ...
                ptrC(ptrC_), layoutC(layoutC_), ptrBias(ptrBias_), ptrScale(ptrScale_) {}
        };
...
#endif // CATLASS_GEMM_KERNEL_QUANT_MATMUL_FP_HPP
