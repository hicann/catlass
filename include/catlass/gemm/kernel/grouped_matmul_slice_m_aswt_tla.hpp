...
#ifndef CATLASS_GEMM_KERNEL_GROUPED_MATMUL_SLICE_M_ASWT_TLA_HPP
#define CATLASS_GEMM_KERNEL_GROUPED_MATMUL_SLICE_M_ASWT_TLA_HPP
...
>
class GroupedMatmulSliceMAswtTla {
public:
    ...
    void operator()<AscendC::AIC>(Params const &params)
    {
        ...
        for (uint32_t groupIdx = 0; groupIdx < params.problemCount; ++groupIdx) {
            ...
            for (uint32_t loopIdx = 0; loopIdx < coreLoops; ++loopIdx) {
                ...
                auto blockCoord = blockScheduler.GetBlockCoordByElement();
...
#endif // CATLASS_GEMM_KERNEL_GROUPED_MATMUL_SLICE_M_ASWT_TLA_HPP