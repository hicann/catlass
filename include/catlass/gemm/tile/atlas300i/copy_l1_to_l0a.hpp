...
#ifndef CATLASS_GEMM_TILE_ATLAS300I_COPY_L1_TO_L0A_HPP
#define CATLASS_GEMM_TILE_ATLAS300I_COPY_L1_TO_L0A_HPP
...
struct CopyL1ToL0A<
    ArchTag,
    Catlass::Gemm::GemmType<Element, layout::zZ, AscendC::TPosition::A1>,
    ...
    )
    {
        ...
        loadDataParams.repeatTimes = layoutDst.shape(3);
