...
#include "catlass/gemm/tile/ascend950/copy_l1_to_l0b.hpp"
#endif
#if (defined(CATLASS_ARCH) && CATLASS_ARCH == 2002)
#include "catlass/gemm/tile/atlas300i/copy_l1_to_l0b.hpp"
#endif
#if (defined(CATLASS_ARCH) && CATLASS_ARCH == 3002)
#include "catlass/gemm/tile/atlas200i/copy_l1_to_l0b.hpp"
#endif
