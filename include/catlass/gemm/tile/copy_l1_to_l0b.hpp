...
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::zZ>, Catlass::Gemm::GemmType<Element, layout::nZ>>{
...
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<float, layout::zZ>, Catlass::Gemm::GemmType<float, layout::nZ>>{
    using Element = float;
    using LayoutDst = layout::nZ;
    using LayoutSrc = layout::zZ;
...
// RowMajor 
template<class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::zN>, Catlass::Gemm::GemmType<int8_t, layout::nZ>>{
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::zN>, Catlass::Gemm::GemmType<Element, layout::zN>>{
...
// ColumnMajor
template<class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::nZ>, Catlass::Gemm::GemmType<Element, layout::nN>>{
...
template <class ArchTag, class Element>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<Element, layout::nN>, Catlass::Gemm::GemmType<Element, layout::zN>>
{
    using LayoutDst = layout::zN;
...
// L1B -> L0B colummMajor, nN -> zN
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<float, layout::nN>, Catlass::Gemm::GemmType<float, layout::zN>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nN;
    using Element = float;
...
template <class ArchTag>
struct CopyL1ToL0B<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::nZ>, Catlass::Gemm::GemmType<int8_t, layout::zN>>{
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nZ;
    using Element = int8_t;
