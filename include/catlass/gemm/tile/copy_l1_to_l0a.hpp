...
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<Element, layout::zN>, Catlass::Gemm::GemmType<Element, layout::zZ>>{
...
// ColumnMajor
template<class ArchTag, class Element>
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<Element, layout::nN>, Catlass::Gemm::GemmType<Element, layout::zN>>{
...
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<float, layout::nN>, Catlass::Gemm::GemmType<float, layout::zN>>{
    using Element = float;
    using LayoutDst = layout::zN;
    using LayoutSrc = layout::nN;
...
// ColumnMajor
template<class ArchTag>
struct CopyL1ToL0A<ArchTag, Catlass::Gemm::GemmType<int8_t, layout::nZ>, Catlass::Gemm::GemmType<int8_t, layout::zN>>{
