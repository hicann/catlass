...
struct BlockMmadTla<
    MmadXASharedPV<Arch::Ascend950>, L1TileShape_, L0TileShape_, ElementA_, ElementB_, ElementC_, ElementBias_,
    TileCopy_, TileMmad_> {
public:
...
public:
    ...
    CATLASS_DEVICE void operator()(
        ...
        uint32_t& taskIdL0B, uint16_t PV_RELEASE_FLAG)
    {
        ...
        auto tensorBL1Tile = GetTile(tensorBInL1, tla::MakeCoord(0, 0), tla::MakeShape(blockK, blockN));
