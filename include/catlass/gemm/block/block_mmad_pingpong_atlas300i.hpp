...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_ATLAS300I_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_ATLAS300I_HPP
...
template <
    ...
    class TileMmad_>
struct BlockMmad<
    MmadAtlas300IPingpong<ENABLE_ABBA_>,
    L1TileShape_,
    L0TileShape_,
    AType_,
    BType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlas300IPingpong<ENABLE_ABBA_>;
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        l0C2Tensor = resource.ubBuf.template GetBufferByByte<ElementC>(0);
    ...
    )
    {
        ...
        if constexpr (std::is_same_v<LayoutC, layout::zN>) {
            copyUBToGm(gmC, l0C2Tensor, layoutBlock, layoutInL0C, layoutC);
        } else {
            copyUBToGm(gmC, l0C2Tensor, layoutBlock, layoutInL0C);
        }
        AscendC::SetFlag<AscendC::HardEvent::MTE3_V>(EVENT_ID0);
    }
...
protected:
    ...
    AscendC::LocalTensor<ElementC> l0C2Tensor;
