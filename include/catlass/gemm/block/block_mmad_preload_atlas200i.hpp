...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_ATLAS200I_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PRELOAD_ATLAS200I_HPP
...
template <
    ...
    class TileCopy_,
    class TileMmad_>
struct BlockMmad<MmadAtlas200IPreload<ENABLE_ABBA_>, L1TileShape_, L0TileShape_, AType_, BType_, CType_, BiasType_, TileCopy_, TileMmad_> {
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlas200IPreload<ENABLE_ABBA_>;
