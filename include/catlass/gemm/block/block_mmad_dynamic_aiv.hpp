#ifndef CATLASS_GEMM_BLOCK_MMAD_AIV_HPP
#define CATLASS_GEMM_BLOCK_MMAD_AIV_HPP
...
>
struct BlockMmadAiv <
    MmadAtlasA2Aiv<SCALAR_BUFFER_ELE_NUM_, STAGES_>,
    AType_,
    BType_,
    CType_,
    BiasType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2Aiv<SCALAR_BUFFER_ELE_NUM_, STAGES_>;
...
>
struct BlockMmadAiv <
    MmadAtlasA2AivSimple<SCALAR_BUFFER_ELE_NUM_, IS_TILE_M_>,
    AType_,
    BType_,
    CType_,
    BiasType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2AivSimple<SCALAR_BUFFER_ELE_NUM_, IS_TILE_M_>;
    using ArchTag = typename DispatchPolicy::ArchTag;
    using ElementA = typename AType_::Element;
    using LayoutA = typename AType_::Layout;
    using ElementB = typename BType_::Element;
...
>
struct BlockMmadAiv <
    MmadAtlasA2AivTrans<SCALAR_BUFFER_ELE_NUM_>,
    AType_,
    BType_,
    CType_,
    BiasType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlasA2AivTrans<SCALAR_BUFFER_ELE_NUM_>;
    using ArchTag = typename DispatchPolicy::ArchTag;
    using ElementA = typename AType_::Element;
    using LayoutA = typename AType_::Layout;
    using ElementB = typename BType_::Element;
...
#endif // CATLASS_GEMM_BLOCK_MMAD_AIV_HPP