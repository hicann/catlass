...
struct BlockMmadTla<
    MmadXASharedQK<Arch::Ascend950>, L1TileShape_, L0TileShape_, ElementA_, ElementB_, ElementC_, ElementBias_,
    TileCopy_, TileMmad_> {
public:
...
public:
    ...
    CATLASS_DEVICE void operator()(
        ...
        bool isFirstKv, bool isLastKv, uint32_t& taskIdL0A, uint32_t& taskIdL0B)
    {
        ...
        auto tensorBL1Tile = GetTile(tensorBInL1, tla::MakeCoord(0, 0), tla::MakeShape(dimActual, kActual));
