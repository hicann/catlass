...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_PRELOAD_TLA_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_PINGPONG_PRELOAD_TLA_HPP
...
>
struct BlockMmadTla <
    MmadPingpongPreLoad<ArchTag_, ENABLE_UNIT_FLAG_, USE_HF32_MODE_, L0C_STAGES_, ENABLE_L1_RESIDENT_, L1A_STAGES_, 
...
public:
    // Type Aliases
    using DispatchPolicy = MmadPingpongPreLoad<ArchTag_, ENABLE_UNIT_FLAG_, USE_HF32_MODE_, L0C_STAGES_, ENABLE_L1_RESIDENT_, 
    ...
    CATLASS_DEVICE void operator()(TensorA &tensorA, TensorB &tensorB, TensorC &tensorC, GemmCoord const &actualShape,
        TensorBias const &tensorBias = {}, Callback const &callbackBeforeFixpipe = {}, Callback const &callbackAfterFixpipe = {})
    {
        // Check L1TileShape
        if constexpr (HAS_BIAS) {
