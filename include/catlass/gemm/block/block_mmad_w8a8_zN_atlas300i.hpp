...
#ifndef CATLASS_GEMM_BLOCK_BLOCK_MMAD_W8A8_ZN_ATLAS300I_HPP
#define CATLASS_GEMM_BLOCK_BLOCK_MMAD_W8A8_ZN_ATLAS300I_HPP
...
template <
    ...
    class TileMmad_>
struct BlockMmad<
    MmadAtlas300IW8a8zN<ENABLE_ABBA_>,
    L1TileShape_,
    L0TileShape_,
    AType_,
    BType_,
...
public:
    // Type Aliases
    using DispatchPolicy = MmadAtlas300IW8a8zN<ENABLE_ABBA_>;
    ...
    static_assert(
        (L1TileShape::M * L1TileShape::N * sizeof(ElementAccumulator) + L1TileShape::N * sizeof(ElementScale)
         + L1TileShape::N * sizeof(ElementAccumulator) + L1TileShape::M * L1TileShape::N * sizeof(ElementC))
            <= ArchTag::UB_SIZE,
    ...
    BlockMmad(Arch::Resource<ArchTag> &resource, uint32_t l1BufAddrStart = 0)
    {
        ...
        fp32Tensor = resource.ubBuf.template GetBufferByByte<ElementScale>(0); // reuse the l0C2Tensor's memory
        ...
        AscendC::SetFlag<AscendC::HardEvent::V_MTE2>(scaleEvent);
        AscendC::SetFlag<AscendC::HardEvent::V_MTE2>(biasEvent);
    }
    ...
    ~BlockMmad()
    {
        ...
        AscendC::WaitFlag<AscendC::HardEvent::V_MTE2>(scaleEvent);
        AscendC::WaitFlag<AscendC::HardEvent::V_MTE2>(biasEvent);
    }
    ...
    )
    {
        ...
        AscendC::SetFlag<AscendC::HardEvent::MTE2_V>(scaleEvent);
        ...
        AscendC::SetFlag<AscendC::HardEvent::MTE2_V>(biasEvent);
        ...
        AscendC::WaitFlag<AscendC::HardEvent::MTE2_V>(biasEvent);
        AscendC::SetFlag<AscendC::HardEvent::V_MTE2>(biasEvent);
        ...
        AscendC::PipeBarrier<PIPE_V>();
        AscendC::WaitFlag<AscendC::HardEvent::MTE2_V>(scaleEvent);
