...
struct BlockMmad<
    MmadAtlasA2FAIQKSplitRow<PAGED_CACHE_FLAG_, ENABLE_UNIT_FLAG_>, L1TileShape_, L0TileShape_, AType_, BType_, CType_,
...
public:
    ...
    void operator()(
        ...
        GemmCoord actualOriShape, uint32_t& nIdx, uint32_t& blockSize, uint32_t strideKV, uint32_t& l1KPPingPongFlag,
        uint32_t& l0ABPingPongFlag, uint32_t& l0CPingPongFlag)
    {
