...
///////////////////////////////////////////////////////////////////////////////
/// Example 81: Ascend950 FP8 Per-Token Per-Channel Quantized Matrix Multiplication
...
///   AIC core: reads A and B from GM, performs matmul, writes intermediate C to shared UB
///   AIV core: reads C from shared UB, applies per-token and per-channel scales, writes output to GM
///
...
static const std::string kDataRoot = "../../examples/ascend950_fp8_e4m3_quant_matmul/data";
...
static int Run(const Options& options)
{
    ...
    using EpilogueDispatchPolicy = Epilogue::EpilogueAscend950Fp8PerTokenPerChannelDequant<ubStages>;
    ...
    using GemmKernel =
        Gemm::Kernel::MatmulPerTokenPerChannelEpilogueTla<BlockMmadTla, BlockEpilogue, BlockScheduler, ubStages>;
    ...
    ACL_CHECK(
        aclrtMalloc(reinterpret_cast<void**>(&devicePerChannelScale), sizePerChannelScale, ACL_MEM_MALLOC_HUGE_FIRST));
    ACL_CHECK(aclrtMemcpy(
        devicePerChannelScale, sizePerChannelScale, hostPerChannelScale.data(), sizePerChannelScale,
        ACL_MEMCPY_HOST_TO_DEVICE));
