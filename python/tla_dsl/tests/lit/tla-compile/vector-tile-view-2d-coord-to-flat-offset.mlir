...
module {
  ...
  ^bb0(%arg0: !tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, gm, 4>>):
    ...
    %10 = tla.make_tensor_like %1 like %9 layoutTag(#tla.layout_tag<RowMajor>) : !tla.ptr<f32, ub, 256>, !tla.tensor<!tla.layout<!tla.shape<16,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<?,0>, !tla.ptr<f32, gm, 4>> -> !tla.tensor<!tla.layout<!tla.shape<?,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>
    %11 = tla.make_tensor_like %3 like %9 layoutTag(#tla.layout_tag<RowMajor>) : !tla.ptr<f32, ub, 256>, !tla.tensor<!tla.layout<!tla.shape<16,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<?,0>, !tla.ptr<f32, gm, 4>> -> !tla.tensor<!tla.layout<!tla.shape<?,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>
    %12 = tla.make_tensor_like %5 like %9 layoutTag(#tla.layout_tag<RowMajor>) : !tla.ptr<f32, ub, 256>, !tla.tensor<!tla.layout<!tla.shape<16,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<?,0>, !tla.ptr<f32, gm, 4>> -> !tla.tensor<!tla.layout<!tla.shape<?,32>, !tla.stride<32,1>, !tla.shape<?,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>
