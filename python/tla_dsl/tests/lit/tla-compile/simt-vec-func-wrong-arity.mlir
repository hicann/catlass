...
module {
  func.func @wrong_arity(%src_memref: memref<1xf32, #hivm.address_space<gm>>) {
    ...
    "tla.vector"() ({
      ...
      }) {mode = "simt", thread_block_dim = array<i64: 64, 1>} : () -> ()
    }) : () -> ()
    return
  }
}
// CHECK: 'thread_block_dim' must have exactly 3 elements, got 2
