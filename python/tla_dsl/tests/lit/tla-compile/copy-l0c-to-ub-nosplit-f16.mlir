...
module attributes {tla.module_exec_units = "cube"} {
  ...
  ^bb0(%arg0: !tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, gm, 4>>):
    ...
    "tla.cube"() ({
      ...
      %13 = tla.make_tensor %8, %11, %12 : !tla.ptr<f16, ub, 256>, !tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, RowMajor>, !tla.coord<0,0> -> !tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f16, ub, 256>>
      ...
      "tla.copy"(%13, %6, %14) : (!tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f16, ub, 256>>, !tla.tensor<!tla.layout<!tla.shape<(16,2),(16,2)>, !tla.stride<(16,256),(1,512)>, !tla.shape<32,32>, L0Clayout>, !tla.coord<0,0>, !tla.ptr<f32, l0c, 512>>, !tla.copy_l0c2dst_params) -> ()
    }) : () -> ()
    "tla.return"() : () -> ()
...
// CHECK-F16: func.func private @copy_l0c_to_ub_RowMajor_nosplit_half
...
// CHECK-F16: call @copy_l0c_to_ub_RowMajor_nosplit_half([[CC]], [[UB]]
// CHECK-F16-SAME: i8
// CHECK-F16-SAME: i8
// CHECK-F16-NOT: "tla.copy"
// CHECK-F16-NOT: "tla.CopyL0C2DstParams"

// CHECK-BF16: func.func private @copy_l0c_to_ub_RowMajor_nosplit_bf16
...
// CHECK-BF16: call @copy_l0c_to_ub_RowMajor_nosplit_bf16([[CC]], [[UB]]
// CHECK-BF16-SAME: i8
// CHECK-BF16-SAME: i8
