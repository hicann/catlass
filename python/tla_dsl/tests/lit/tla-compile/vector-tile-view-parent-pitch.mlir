...
!parent = !tla.tensor<!tla.layout<!tla.shape<2,128>, !tla.stride<128,1>, !tla.shape<2,128>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>
!chunk = !tla.tensor<!tla.layout<!tla.shape<1,64>, !tla.stride<128,1>, !tla.shape<1,64>, RowMajor>, !tla.coord<1,0>, !tla.ptr<f32, ub, 256>>
...
module {
  "tla.func"() ({
    ...
    %layout = tla.make_layout %parent_shape, %parent_stride : !tla.shape<2,128>, !tla.stride<128,1> -> !tla.layout<!tla.shape<2,128>, !tla.stride<128,1>, !tla.shape<2,128>, RowMajor>
    %parent_coord = tla.make_coord -> !tla.coord<0,0>
    %parent = tla.make_tensor %ptr, %layout, %parent_coord : !tla.ptr<f32, ub, 256>, !tla.layout<!tla.shape<2,128>, !tla.stride<128,1>, !tla.shape<2,128>, RowMajor>, !tla.coord<0,0> -> !parent
    "tla.vector"() ({
      "tla.vec.func"() ({
