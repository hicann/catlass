...
!ub_strided = !tla.tensor<!tla.layout<!tla.shape<4>, !tla.stride<2>, !tla.shape<16>, row_major>, !tla.coord<4>, !tla.ptr<f32, ub, 4>>
...
module {
  func.func @simt_strided_view(%ub_memref: memref<16xf32, #hivm.address_space<ub>>) {
    ...
    "tla.vector"() ({
      "tla.vec.func"() ({
        %v = tla.simt_load %strided[%c1] : <!tla.layout<!tla.shape<4>, !tla.stride<2>, !tla.shape<16>, row_major>, !tla.coord<4>, !tla.ptr<f32, ub, 4>> -> f32
        tla.simt_store %strided[%c2], %v : <!tla.layout<!tla.shape<4>, !tla.stride<2>, !tla.shape<16>, row_major>, !tla.coord<4>, !tla.ptr<f32, ub, 4>>, f32
