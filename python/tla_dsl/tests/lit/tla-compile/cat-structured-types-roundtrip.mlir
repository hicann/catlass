...
module {
  func.func @structured_type_roundtrip(
    ...
    %parent_layout = tla.make_layout %parent_shape, %parent_stride : !tla.shape<16,16>, !tla.stride<16,1> -> !tla.layout<!tla.shape<16,16>, !tla.stride<16,1>, !tla.shape<16,16>, RowMajor>
...
// CHECK: !tla.layout<!tla.shape<(?,16),8>, !tla.stride<(16,1),128>, !tla.shape<(32,16),8>, RowMajor>
