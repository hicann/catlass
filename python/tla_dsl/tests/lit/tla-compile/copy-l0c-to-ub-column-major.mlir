...
//
// Test lowering of tla.copy from L0C to UB with column_major destination (NO_SPLIT_VEC_0).
...
module attributes {tla.module_exec_units = "cube"} {
  ...
  ^bb0(%arg0: !tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, row_major>, !tla.coord<0,0>, !tla.ptr<f32, gm, 4>>):
    ...
    "tla.cube"() ({
      ...
      %11 = tla.make_layout %9, %10 : !tla.shape<32,32>, !tla.stride<1,32> -> !tla.layout<!tla.shape<32,32>, !tla.stride<1,32>, !tla.shape<32,32>, column_major>
      %12 = tla.make_coord -> !tla.coord<0,0>
      %13 = tla.make_tensor %8, %11, %12 : !tla.ptr<f32, ub, 256>, !tla.layout<!tla.shape<32,32>, !tla.stride<1,32>, !tla.shape<32,32>, column_major>, !tla.coord<0,0> -> !tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<1,32>, !tla.shape<32,32>, column_major>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>
      ...
      "tla.copy"(%13, %6, %14) : (!tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<1,32>, !tla.shape<32,32>, column_major>, !tla.coord<0,0>, !tla.ptr<f32, ub, 256>>, !tla.tensor<!tla.layout<!tla.shape<(16,2),(16,2)>, !tla.stride<(16,256),(1,512)>, !tla.shape<32,32>, L0Clayout>, !tla.coord<0,0>, !tla.ptr<f32, l0c, 512>>, !tla.copy_l0c2dst_params) -> ()
    }) : () -> ()
    "tla.return"() : () -> ()
  }) {tla.exec_units = "cube", function_type = (!tla.tensor<!tla.layout<!tla.shape<32,32>, !tla.stride<32,1>, !tla.shape<32,32>, row_major>, !tla.coord<0,0>, !tla.ptr<f32, gm, 4>>) -> (), sym_name = "copy_l0c2ub_col_f32"} : () -> ()
}

// ---- F32->F32 ----
// CHECK-F32: func.func private @copy_l0c_to_ub_column_major_nosplit_float
...
// CHECK-F32: call @copy_l0c_to_ub_column_major_nosplit_float([[CC]], [[UB]]
// CHECK-F32-NOT: "tla.copy"
// CHECK-F32-NOT: "tla.CopyL0C2DstParams"

// ---- F32->F16 ----
// CHECK-F16: func.func private @copy_l0c_to_ub_column_major_nosplit_half
...
// CHECK-F16: call @copy_l0c_to_ub_column_major_nosplit_half([[CC]], [[UB]]
