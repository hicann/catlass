  ...
  func.func @mmad_runtime_call_bf16(
    ...
    "tla.mmad"(%acc, %lhs, %rhs) {init_c = true}
        : (!tla.tensor<!tla.layout<!tla.shape<(16,8),(16,8)>, !tla.stride<(16,256),(1,2048)>, !tla.shape<128,128>, L0Clayout>, !tla.coord<0,0>, !tla.ptr<f32, l0c, 512>>,
           ...
           !tla.tensor<!tla.layout<!tla.shape<(16,4),(16,8)>, !tla.stride<(1,2048),(16,256)>, !tla.shape<64,128>, nZ>, !tla.coord<0,0>, !tla.ptr<bf16, l0b, 512>>) -> ()
    func.return
  }
}
...
// CHECK: call @mmad_bf16_bf16_float({{%.*}}, {{%.*}}, {{%.*}}, [[MN]], [[MN]], [[K]], [[INIT]], {{%.*}})
// CHECK: return
// CHECK-NOT: tla.mmad
