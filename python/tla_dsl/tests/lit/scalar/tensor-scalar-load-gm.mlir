...
module {
  tla.func @read_scalar(%arg0: !tla.tensor<!tla.layout<!tla.shape<1,8>, !tla.stride<8,1>, !tla.shape<1,8>, RowMajor>, !tla.coord<0,0>, !tla.ptr<i32, gm, 4>>) {
    %c0 = arith.constant 0 : index
    %c3 = arith.constant 3 : index
    %0 = tla.scalar_load %arg0[%c0, %c3] : !tla.tensor<!tla.layout<!tla.shape<1,8>, !tla.stride<8,1>, !tla.shape<1,8>, RowMajor>, !tla.coord<0,0>, !tla.ptr<i32, gm, 4>> -> i32
    tla.return
  }
}
