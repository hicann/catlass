...
// HELPER: %[[REDUCE_MASK:.*]] = ave.hir.pge <ALL> {element_alignment_bit_width = 32 : i32} : vector<256xi1>
// HELPER: %[[REDUCED:.*]] = ave.hir.reduction <add>
// HELPER: %[[STORE_MASK:.*]], %{{.*}} = ave.hir.plt
...
!vec1 = !tla.tensor<!tla.layout<!tla.shape<1>, !tla.stride<1>, !tla.shape<1>, RowMajor>, !tla.coord<0>, !tla.ptr<f32, ub, 4>>
