...
!ub_2d = !tla.tensor<!tla.layout<!tla.shape<2,4>, !tla.stride<4,1>, !tla.shape<2,4>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 4>>
...
module {
  func.func @simt_rank2(%ub_memref: memref<8xf32, #hivm.address_space<ub>>) {
    ...
    "tla.vector"() ({
      "tla.vec.func"() ({
        %v = tla.simt_load %m[%c1, %c2] : <!tla.layout<!tla.shape<2,4>, !tla.stride<4,1>, !tla.shape<2,4>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 4>> -> f32
        tla.simt_store %m[%c0, %c1], %v : <!tla.layout<!tla.shape<2,4>, !tla.stride<4,1>, !tla.shape<2,4>, RowMajor>, !tla.coord<0,0>, !tla.ptr<f32, ub, 4>>, f32
