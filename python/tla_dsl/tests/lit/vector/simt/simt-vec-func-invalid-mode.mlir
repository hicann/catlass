...
module {
  func.func @invalid_mode(%src_memref: memref<1xf32, #hivm.address_space<gm>>) {
    ...
    "tla.vector"() ({
      ...
      }) {mode = "banana", thread_block_dim = array<i64: 64, 1, 1>} : () -> ()
    }) : () -> ()
    return
  }
}
// CHECK: mode must be "simd" or "simt", got "banana"
