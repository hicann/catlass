...
module {
  "tla.func"() ({
    ...
    %zn_layout = "tla.make_layout"(%shape, %zn_stride, %origin) {layoutTag = #tla.layout_tag<zN>} :
    ...
    %nz_layout = "tla.make_layout"(%shape, %nz_stride, %origin) {layoutTag = #tla.layout_tag<nZ>} :
    ...
    %unalign_layout = "tla.make_layout"(%unalign_shape, %unalign_stride, %origin) {layoutTag = #tla.layout_tag<zNUnAlign>} :
