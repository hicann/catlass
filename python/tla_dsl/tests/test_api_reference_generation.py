...
def test_generated_api_reference_is_current() -> None:
    """Fail when docs/kernel-api-reference.md is stale relative to core_api.py / generator."""
    package_root = pathlib.Path(__file__).resolve().parents[1]
    doc = package_root / "docs" / "kernel-api-reference.md"
    ...
    raise AssertionError(
        "docs/kernel-api-reference.md is out of date. Regenerate with:\n"
