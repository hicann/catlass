...
CATLASS DSL 的核心概念与编程模型，包括 DSL 语法约束、控制流、Layout、Tensor 接入，
以及 Host 侧编译与启动。
...
| [编译与启动](compile_and_launch.md) | 编译样本、缓存、重复启动与 stream。 |
| [结构化 Kernel 参数](structured_arguments.md) | tuple/list、结构化对象、静态字段与自定义 adapter 的传参方式。 |
