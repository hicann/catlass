...
Host-side `@tla.kernel` and `@tla.extern` declarations, plus Host `@dataclass` packing. Decorated kernel and extern declaration bodies are not executed on the Host.

### `kernel`

**Source:** [`catlass.dsl.kernel`](../../../catlass/dsl.py#L290)
...
**Source:** [`dataclasses.dataclass`](../../../catlass/execution_lowering.py#L830)
...
**Source:** [`catlass.dsl.TlaJitFunction.compile`](../../../catlass/dsl.py#L179)
...
**Source:** [`catlass.base_dsl.jit_executor.JitCompiledFunction.__call__`](../../../catlass/base_dsl/jit_executor.py#L302)
...
**Source:** [`catlass.dsl.TlaJitFunction.dump_mlir`](../../../catlass/dsl.py#L238)
