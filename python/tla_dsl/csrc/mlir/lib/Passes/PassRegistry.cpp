...
void registerTlaPasses()
{
    ...
    mlir::registerPass([]() -> std::unique_ptr<mlir::Pass> { return hivmave::createCombineAVEOPsPass(); });
    mlir::registerPass([]() -> std::unique_ptr<mlir::Pass> { return mlir::createConvertHIVMAVEToAVEIntrinPass(); });
