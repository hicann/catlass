...
out_dir="${BASIC_MMAD_ARTIFACT_DIR:-$script_dir/artifacts}"
python -B examples/end_to_end/basic_mmad/dump_ir.py --out-dir "$out_dir"
...
tmp_tlair="$(mktemp "$out_dir/0_basic_mmad.tlair.XXXXXX.mlir")"
