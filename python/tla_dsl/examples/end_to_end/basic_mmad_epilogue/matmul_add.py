...
def matmul_evg_add_kernel(
    ...
    """Cube GEMM to GM workspace; vector epilogue D = Acc + X (X from gm_c)."""
    c0 = 0
    c1 = 1
    ...
    # Folded at compile time via _swizzle.SWIZZLE_DIRECTION (host-set), like EVG_UB_STAGES.
...
def run(args: argparse.Namespace) -> int:
    ...
    artifact(a_tensor, b_tensor, c_tensor, wks_tensor, block_num=block_num)
