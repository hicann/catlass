    ...
    with tla.vector():
        ...
        for block_linear in block_range:
            ...
            gm_bias_by_core = tla.tile_view(
                gm_bias, tla.make_shape(1, _tiling.l1_tn), tla.make_coord(c0, block_col)
            )
...
def run(args: argparse.Namespace) -> int:
    ...
    bias = torch.rand(1, args.n, dtype=dtype_c, device="npu") * 10.0 - 5.0
    ...
    bias_tensor = create_tla_tensor(bias, "row")
