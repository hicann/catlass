...
def dump_tlair(
    ...
    return matmul_evg_sigmoid_kernel.dump_mlir(
...
def _print_case_result(
    *,
    ...
    print(f"D equals expected sigmoid(A@B)? {expected_match_all}")
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Compile/run matmul EVG sigmoid: D=sigmoid(A@B) via L0C→GM "
