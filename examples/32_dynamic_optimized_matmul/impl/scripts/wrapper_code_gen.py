...
from templates.padding_muti_core_splitk_matmul_template import PaddingMutiCoreSplitkMatmulTemplate
...
if __name__ == "__main__":
    ...
    PaddingMutiCoreSplitkMatmulTemplate.gen_code("PaddingMutiCoreSplitkMatmulKernel", "padding_muti_core_splitk_matmul_kernel", 3, "half", kernel_info)
