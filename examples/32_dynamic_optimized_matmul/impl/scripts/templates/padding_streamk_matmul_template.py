...
{{
    ...
    LaunchPaddingStreamkMatmulKernel<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC,
...
{{
    ...
    constexpr PaddingTag paddingTagA = {padding_tag_a};
    constexpr PaddingTag paddingTagB = {padding_tag_b};
    return PaddingStreamkMatmulKernelGetWorkspaceSize<ElementA, LayoutA, ElementB, LayoutB, ElementC, LayoutC,
...
"""
    ...
    def gen_code(kernel_name, base_file_name, kernel_serial, dtype, kernel_info):
        ...
        for l_tag_a, l_tag_b, p_tag_a, p_tag_b in combinations:
            ...
            # file name can be padding_steamk_matmul_kernel_half_layout_00.cpp
            file_name = (
                base_file_name
                + "_"
                + dtype
