...
```
## 使用示例
- 获取代码之后编译相应的算子可执行文件，可参考[quickstart](../../docs/quickstart.md#算子编译)，本用例为950算子，编译时需加-DCATLASS_ARCH=3501
- 执行算子
```
# 编译指定用例
bash scripts/build.sh 42_950_basic_matmul -DCATLASS_ARCH=3501
cd output/bin
