...
template <
    ...
    class LayoutA,
    class LayoutTemp>
ACOT_GLOBAL void INT8CMEPIGEMV(
    uint64_t fftsAddr,
    ...
    GM_ADDR gmWorkspace)
{
    ...
    using TempType = gemv::GemvType<int32_t, LayoutTemp>;
...
struct Options
{
    const std::string HELPER = "04_gemv_04_int8_cm_epi_gemv m n [device_id]";
...
void Run(Options const &options)
{
    ...
    size_t sizez = lenz * sizeof(int32_t);
    size_t sizey = sizez;
    ...
    INT8CMEPIGEMV<<<aicCoreNum, nullptr, stream>>>(
        fftsAddr,
        alpha[0], beta[0],
