    ...
    GM_ADDR gmy, Layouty layouty)
{
    ...
    using L1TileShape = GemvShape<1024, 32>;
    using L0TileShape = GemvShape<1024, 32>;

    using xType = gemv::GemvType<int8_t, Layoutx>;
    using AType = gemv::GemvType<int8_t, LayoutA>;
    using yType = gemv::GemvType<int32_t, Layouty>;
...
struct Options
{
    const std::string HELPER = "04_gemv_04_int8_cm_gemv m n [device_id]";
...
void Run(Options const &options)
{
    ...
    size_t sizey = leny * sizeof(int32_t);
