    ...
    GM_ADDR gmy, Layouty layouty)
{
    ...
    using yType = gemv::GemvType<half, Layouty>;
...
struct Options
{
    const std::string HELPER = "04_gemv_01_fp16_cm_gemv m n [device_id]";
...
void Run(Options const &options)
{
    ...
    FP16CMGEMV<<<aicCoreNum, nullptr, stream>>>(
