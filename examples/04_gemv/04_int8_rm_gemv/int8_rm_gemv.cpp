    ...
    GM_ADDR gmy, Layouty layouty)
{
    ...
    using L0TileShape = GemvShape<32, 1024>;
...
struct Options
{
    const std::string HELPER = "04_gemv_04_int8_rm_gemv m n [device_id]";
...
void Run(Options const &options)
{
    ...
    INT8RMGEMV<<<aicCoreNum, nullptr, stream>>>(
