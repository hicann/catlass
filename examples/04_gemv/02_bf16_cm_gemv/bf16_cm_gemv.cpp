    ...
    GM_ADDR gmy, Layouty layouty)
{
    ...
    using yType = gemv::GemvType<bfloat16_t, Layouty>;
...
struct Options
{
    const std::string HELPER = "04_gemv_02_bf16_cm_gemv m n [device_id]";
...
void Run(Options const &options)
{
    ...
    size_t sizex = lenx * sizeof(bfloat16_t);
    ...
    BF16RMGEMV<<<aicCoreNum, nullptr, stream>>>(
