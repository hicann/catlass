...
#include "catlass/gemm/kernel/grouped_matmul_add_atomic.hpp"
...
struct Options {
    const std::string HELPER = "33_grouped_matmul_add_atomic group_count m n k [device_id]";
...
void Run(Options const &options)
{
    ...
    ACL_CHECK(aclrtMemcpy(problemShapeListDevice,
        sizeProblemShapeList,
    ...
    using MmadDispatchPolicy = Gemm::MmadAtlasA2PingpongAtomic<enableUnitFlag>;
    ...
    using MatmulKernel = Gemm::Kernel::GroupedMatmulAddAtomic<BlockMmad, BlockEpilogue, BlockScheduler>;
