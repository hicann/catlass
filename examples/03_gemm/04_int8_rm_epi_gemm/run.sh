...
# ../../../scripts/build.sh 04_int8_rm_epi_gemm
# msprof op --output=./prof ../../../build/bin/04_int8_rm_epi_gemm $M $N $K $deviceId
../../../build/bin/04_int8_rm_epi_gemm $M $N $K $deviceId $mode
# 验证数据
python3 ./scripts/verify_data.py $M $N $K
rm -rf ./data/input ./data/output
# 性能测试 注意路径问题
# cd ./examples/03_gemm/04_int8_rm_epi_gemm/
