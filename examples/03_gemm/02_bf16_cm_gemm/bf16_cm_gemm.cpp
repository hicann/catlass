...
void BF16CMGemm(
    ...
    // 使用Coord来传递值
    using L1TileShape = MatmulShape<256, 96, 256>;
    using L0TileShape = MatmulShape<256, 96, 64>;
...
typedef struct Options{
    const std::string HELPER = "03_gemm/02_bf16_cm_gemm m n k [device_id]";
...
void Run(Options options){
    ...
    BF16CMGemm<<<aicCoreNum, nullptr, stream>>>(
        fftsAddr,
        alpha[0], beta[0],
