...
# msprof op --output=./prof ../../../build/bin/02_bf16_rm_epi_gemm $M $N $K $deviceId
../../../build/bin/02_bf16_rm_epi_gemm $M $N $K $deviceId $mode
# 验证数据
python3 ./scripts/verify_data.py $M $N $K
rm -rf ./data/input ./data/output
# 性能测试 注意路径问题
# cd ./examples/03_gemm/02_bf16_rm_epi_gemm/
