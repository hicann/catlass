...
void FP32EpiGemm(
    ...
    using XType = gemm::GemmType<int32_t, LayoutX>; // A * B 
    using DType = gemm::GemmType<int32_t, LayoutD>;
    // 使用Coord来传递值
...
void Run(Options options){
    ...
    layout::ColumnMajor layoutX{m, n};
    layout::ColumnMajor layoutD{m, n}; // 最后的答案矩阵
