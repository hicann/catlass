...
#include "catlass/epilogue/tile/tile_elemwise_relu.hpp"
...
void Run(Options const &options)
{
    ...
    using TileElemWiseEpilogue = Epilogue::Tile::TileElemWiseRelu<ArchTag, ComputeType, computeLength>;
    using EpilogueTileCopy = Epilogue::Tile::TileCopy<ArchTag, CType, DType, DType>;
    using BlockEpilogue = Epilogue::Block::BlockEpilogue<EpilogueDispatchPolicy, CType, DType,
    ...
    golden::ComputeMatmulElemWiseRelu(options.problemShape, hostA, layoutA, hostB, layoutB, hostGolden, layoutD);
