...
)
{
    ...
    using AType = Act::Gemm::GemmType<int8_t, LayoutA>;
    ...
    using ScaleType = Act::Gemm::GemmType<bfloat16_t, layout::VectorLayout>;
    using PerTokenScaleType = Act::Gemm::GemmType<bfloat16_t, layout::VectorLayout>;
    using DType = Act::Gemm::GemmType<bfloat16_t, layout::RowMajor>;
    ...
    if (problemShape.m() > problemShape.n()) {
        ...
        // kernel level
        using MatmulKernel = Act::Gemm::Kernel::QuantMatmulMultiStageWorkspace<BlockMmad, BlockEpilogue,
