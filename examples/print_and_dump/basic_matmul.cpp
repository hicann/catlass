...
void BasicMatmul(
    ...
    AscendC::printf("Kernel stopped");
}

struct Options {
    const std::string HELPER = "printf_and_dump m n k [device_id]";
...
void Run(Options const &options)
{
    ...
    BasicMatmul<<<aicCoreNum, nullptr, stream>>>(
        options.problemShape, deviceA, layoutA, deviceB, layoutB, deviceC, layoutC, deviceDump);
