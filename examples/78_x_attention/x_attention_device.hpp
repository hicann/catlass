...
#ifndef CATLASS_EXAMPLES_X_ATTENTION_DEVICE_HPP
#define CATLASS_EXAMPLES_X_ATTENTION_DEVICE_HPP
    ...
    GM_ADDR sharedBlockTable, GM_ADDR output, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    XAttnKernelParams params{query,
                             sharedKey,
                             sharedValue,
                             unsharedKey,
                             unsharedValue,
...
#endif // CATLASS_EXAMPLES_X_ATTENTION_DEVICE_HPP
