...
using L1TileShape = Act::GemmShape<128, 256, 512>;
...
void Run(Options const & options)
{
    ...
    using DispatchPolicy = Act::Gemm::MmadAtlasA2PreloadAsyncWithCallback<
        preloadStages,
        l1Stages, l0AStages, l0BStages, l0CStages,
        enableUnitFlag, enableShuffleK
    >;
    using L0TileShape = Act::GemmShape<128, 256, 128>;
    ...
    using MatmulKernel = Act::Gemm::Kernel::GroupedMatmulSliceMPerTokenDequantMultiStageWorkspace<BlockMmad, BlockEpilogue,
        BlockScheduler, workspaceStages, ElementGroupList>;

    using MatmulAdapter = Act::Gemm::Device::DeviceGemm<MatmulKernel>;
    
    MatmulKernel::Arguments arguments{
        options.problemShape, problemCount, aicCoreNum, deviceGroupList, deviceA, deviceB, deviceScale,
