...
class TileCopyGmToUbTlaTest : public UBTileCopyTest, public testing::WithParamInterface<TestVectorShape> {
protected:
    void SetUp() override
    {
        AscendCTest::SetUp();
...
class TileCopyGmToUbTlaNonContiguousTest : public UBTileCopyTest,
...
TEST_P(TileCopyGmToUbTlaTest, RowMajorToRowMajorTestBasic)
{
    using Element = float;
    ...
    TileCopyTla<Arch::AtlasA2, decltype(tensorGm), decltype(tensorUb)> copyGmToUb;
...
TEST_P(TileCopyGmToUbTlaNonContiguousTest, RowMajorToRowMajorTestNonContiguous)
{
    using Element = float;
...
INSTANTIATE_TEST_SUITE_P(
    CopyGmToUbTlaNonContiguous,
    TileCopyGmToUbTlaNonContiguousTest,
    ::testing::Values(
