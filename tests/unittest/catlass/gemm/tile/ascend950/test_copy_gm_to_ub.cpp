...
class TileCopyGmToUbTestAscend950 : public UBTileCopyTest, public ::testing::WithParamInterface<TestVectorShape> {
protected:
    void SetUp() override
    {
        AscendCTest::SetUp();
...
class TileCopyGmToUbNonContiguousTestAscend950 : public UBTileCopyTest, public ::testing::WithParamInterface<TestVectorShapeWithStride> {
protected:
    void SetUp() override
    {
        AscendCTest::SetUp();
...
TEST_P(TileCopyGmToUbNonContiguousTestAscend950, RowMajorToRowMajorTestNonContiguous)
{
    ...
    for (uint32_t i = 0; i < datacopyLoops; i++) {
...
INSTANTIATE_TEST_SUITE_P(
    ...
    TileCopyGmToUbNonContiguousTestAscend950,
    ::testing::Values(
