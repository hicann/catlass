...
extern "C" void run(uint32_t blockNum, aclrtStream stream, const CatlassKernel::MatmulParams* params)
{
    ...
    using EpilogueDispatchPolicy = Catlass::Epilogue::EpilogueAscend950Fp8PerTokenPerChannelDequant<ubStages>;
    ...
    using TileCopyEpilogue = Catlass::Epilogue::Tile::TileCopy<ArchTag, CType, ScaleType, PerTokenScaleType, DType>;
    ...
    using MatmulKernel =
        Catlass::Gemm::Kernel::MatmulPerTokenPerChannelEpilogueTla<BlockMmad, BlockEpilogue, BlockScheduler, ubStages>;
