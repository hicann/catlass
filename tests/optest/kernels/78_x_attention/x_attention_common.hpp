...
#ifndef CATLASS_EXAMPLES_X_ATTENTION_COMMON_HPP
#define CATLASS_EXAMPLES_X_ATTENTION_COMMON_HPP
...
CATLASS_DEVICE
uint32_t GetQSBlockTile(uint32_t) {
    return 128;
}
...
#endif // CATLASS_EXAMPLES_X_ATTENTION_COMMON_HPP
