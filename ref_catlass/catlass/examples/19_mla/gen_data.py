...
class TestPagedMLAttention():
    ...
    def calc_data(self, gen_data_params: GenDataParams, save_file=True):
        ...
        if save_file:  # for offline test
            ...
            # TODO: causal mask is missing?
            return query_nope, query_rope, kv_nope_cache, kv_rope_cache, np.array(block_tables), ref_output
