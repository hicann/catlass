...
# C++03 isn't supported for CXX, but is for ASCEND, so we need to set these manually.
...
set(CMAKE_ASCEND_CREATE_SHARED_LIBRARY
    "<CMAKE_ASCEND_COMPILER> ${CMAKE_LIBRARY_CREATE_ASCEND_FLAGS} <CMAKE_SHARED_LIBRARY_ASCEND_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_ASCEND_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>${__IMPLICIT_LINKS}")

set(CMAKE_ASCEND_CREATE_STATIC_LIBRARY
    "<CMAKE_ASCEND_COMPILER> ${CMAKE_LIBRARY_CREATE_ASCEND_FLAGS} <CMAKE_SHARED_LIBRARY_ASCEND_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> ${CMAKE_STATIC_LIBRARY_CREATE_ASCEND_FLAGS} <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> <LINK_LIBRARIES>${__IMPLICIT_LINKS}")

set(CMAKE_ASCEND_CREATE_SHARED_MODULE ${CMAKE_ASCEND_CREATE_SHARED_LIBRARY})

set(CMAKE_ASCEND_COMPILE_OBJECT
    "<CMAKE_ASCEND_COMPILER> -xcce <DEFINES> <INCLUDES>${__IMPLICIT_INCLUDES} <FLAGS> ${CMAKE_COMPILE_AS_ASCEND_FLAG} ${CMAKE_ASCEND_COMPILE_OPTIONS} ${CMAKE_ASCEND_COMMON_COMPILE_OPTIONS} -pthread -o <OBJECT> -c <SOURCE>")
